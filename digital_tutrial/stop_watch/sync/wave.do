...
add wave -noupdate -format Logic /sync_tb/sync/i_clk
add wave -noupdate -format Logic /sync_tb/sync/i_start_en
add wave -noupdate -format Logic /sync_tb/sync/i_clr_en
add wave -noupdate -format Logic /sync_tb/sync/i_rstn
